...
import com.hoob.search.sys.common.Method;

public class HttpUtils {
	private static Logger log = LoggerFactory.getLogger(HttpUtils.class);

	private static int rTimeout = 60 * 1000;
	private static int cTimeout = 60 * 1000;
	private static String mediaXmlType = "application/xml";
//
	public static String doXmlRequest(String url, String body) throws Exception {
		return doRequest(Method.POST, url, body, mediaXmlType);
	}
